...
import frc.robot.commands.MoveBallInHopper;
...
public class OI {
    ...
    public OI() {
         ...
         */
         ...
         JoystickButton moveBall = new JoystickButton(rightAuxStick, ButtonMap.MOVE_BALL);
        ...
        moveBall.whileHeld(new MoveBallInHopper());
